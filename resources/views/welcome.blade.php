        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <div class="flex gap-3 text-sm leading-normal">
                    <a class="flex-1 text-center dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal" href="{{ route('page_array_controller', [ 'pageArray' => 1 ]) }}">
                        Page array - Controller
                    </a>
                    <a class="flex-1 text-center dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal" href="{{ route('relation_page_controller', [ 'relationPage' => 1 ]) }}">
                        Relation page - Controller
                    </a>
                </div>
            </div>
            <div
